\begin{frame}{Supporting more memory access types, \sout{$acyclic(\lPO \cup \lRF)$}}
  ...
  % \begin{center}
  %   \hfill
  %   \includegraphics[width=0.12\linewidth]{cpp.png} \hfill
  %   \includegraphics[width=0.2\linewidth]{arm.png} \hfill
  %   \raisebox{0.5cm}{\includegraphics[width=0.2\linewidth]{power.png}}
  %   \hfill
  % \end{center}
