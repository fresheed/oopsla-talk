...
\usetheme{default}
\author[ok.john.rus@gmail.com]{Ori Lahav, \textbf{Egor Namakonov}, Jonas Oberhauser, Anton Podkopaev, Viktor Vafeiadis}
\title[-----]{Liveness properties under weak memory}
\subtitle[-----]{based on ``Making Weak Memory Models Fair''@OOPSLA'21}
\institute{
  % \vspace{0.5cm}
  
\raisebox{-1.5cm}{  \includegraphics[height=1.0cm]{logos/TelAvivUni_logo}
  \hspace{0.5cm}
  \hfill
  % \includegraphics[height=0.9cm]{logos/spbu_logo}
  \includegraphics[height=0.9cm]{logos/au}
  \hspace{0.5cm}
  \hfill
