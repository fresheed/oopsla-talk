...
\newcommandx{\dpoText}[5][3={},4={},5={}]{\draw[po,#3] (#1) edge[#5] node[#4] {$\lPO$} (#2);}
...
\newcommandx{\drf}[5][3={},4={},5={}]{\draw[rf, #3] (#1) edge[#5] node[right,#4] {$\lRF$} (#2);}

% \newcommand{\dmo}[2]{\draw[mo] (#1) edge node {$\lMO$} (#2);}
\newcommand{\dmoext}[3]{\draw[mo, #3] (#1) edge node {$\lMO$} (#2);}
\newcommandx{\dmo}[5][3={},4={},5={}]{\draw[mo, #3] (#1) edge[#5] node[#4] {$\lMO$} (#2);}
