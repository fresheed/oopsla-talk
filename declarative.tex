...
\begin{frame}{Declarative models define allowed executions with graph predicates}
    ...
    \begin{column}{0.5\linewidth}
      ...
      \begin{center}
        ...
        \onslide<15>{
          ...
          \node[] (U2) at (1 * \hof, 0 * \vof) {$\evlab{\lU}{}{l}{0, 1}$};
          \node[] (W2) at (1 * \hof, -2 * \vof) {$\evlab{\lW}{}{l}{0}$};
          \dpoText{U1}{W1}[][][right];
          \dpoText{U2}{W2}[][][right];
          \drf{W1}{U2}[][][left][];
          \drf{W2}{U1}[][][right];
        ...
        \onslide<15>{\node (ex1) at (0.5 * \hof, -5 * \vof){\Large \textcolor{red}{\ding{55}}};}
        \onslide<16->{\node (ex1) at (0.5 * \hof, -5 * \vof){\Large \textcolor{green}{\ding{51}}};}
        \onslide<17->{\node (ex2) at (0.65 * \hof, -5 * \vof){\includegraphics[width=0.1\textwidth]{emoji.png}};}
  ...
  %   \renewcommand{\hof}{2}
  %   \renewcommand{\vof}{1}
  %   % \begin{tikzpicture}[overlay,remember picture, xscale=2, yscale=0.8]
  %   \tikz[overlay, remember picture, xscale=2, yscale=0.8,background rectangle/.style={fill=white}]{  
  %     \node[] (U1) at (0 * \hof, 3 * \vof) {$\evlab{\lU}{}{l}{0, 1}$};
  %     \node[] (W1) at (0 * \hof, 1 * \vof) {$\evlab{\lW}{}{l}{0}$};
  %     \node[] (U2) at (1 * \hof, 3 * \vof) {$\evlab{\lU}{}{l}{0, 1}$};
  %     \node[] (W2) at (1 * \hof, 1 * \vof) {$\evlab{\lW}{}{l}{0}$};
  %     \dpoText{U1}{W1}[][xshift=-1.5cm, yshift=-0.3cm][right];
  %     \dpoText{U2}{W2}[][xshift=-1.5cm, yshift=-0.3cm][right];
