...
\begin{frame}{}
  ...
  \begin{center}
    \begin{tikzpicture}[xscale=2, yscale=0.8]
      ...
      \pause
      \node (Note) at (0, -1.5) {Proving program termination with graph-based reasoning};
      \node (Plog) at (-1.5, -1.3) {}; \node (Graph) at (1.5, -1.3) {};
      \node (Coq) at (3, -1.5) {\includegraphics[width=0.15\textwidth]{coq.png}};
      \node (Dummy) at (-2.5, -1.5) {};
