  ...
  \begin{columns}
    ...
    \begin{column}{0.5\linewidth}
      \begin{tikzpicture}[xscale=1, yscale=1]
          ...
          \myrect{B1}{(0.5, -1.5)}{{\large{\onslide<9-15>{$l \leftarrow 0$}}}}{1cm}{0.5cm}{\BcolorI!50};
          \myrect{B2}{(3.5, -1.5)}{{\large{\onslide<19>{$l \leftarrow 0$}}}}{1cm}{0.5cm}{\BcolorII!50};
          ...
          \draw[mem,transform canvas={xshift=0.3cm,yshift=0.1cm}] (T1t) edge (B1);
          \draw[mem,transform canvas={xshift=0.3cm,yshift=0.1cm}] (B1) edge (T1b);
          \draw[mem,transform canvas={xshift=-1.25cm,yshift=0.1cm}] (T1b) edge (T1t);
          \draw[mem,] (B1) edge (-0.75, -1.5);

          \draw[mem,transform canvas={xshift=0.3cm,yshift=0.1cm}] (T2t) edge (B2);
          \draw[mem,transform canvas={xshift=0.3cm,yshift=0.1cm}] (B2) edge (T2b);
          \draw[mem,transform canvas={xshift=-1.25cm,yshift=0.1cm}] (T2b) edge (T2t);
          \draw[mem,] (B2) edge (2.25, -1.5);
