...
\newcommand{\unsA}{
  \renewcommand{\arrowTIMem}{colorPO}
  \renewcommand{\arrowTIIMem}{colorPO}
  \renewcommand{\arrowMemTI}{colorPO}
  \renewcommand{\arrowMemTII}{colorPO}
}
\newcommand{\selectArrowI}[1]{
  \unsA
  \renewcommand{#1}{\activeColor!80}
}
\newcommand{\selectArrowII}[2]{
  \unsA
  \renewcommand{#1}{\activeColor!80}
  \renewcommand{#2}{\activeColor!80}
}
